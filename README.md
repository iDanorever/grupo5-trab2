...
/backend
/api # Lógica de consumo y control de la API GHL
/models # Definición de modelos y bases de datos
/tests # Pruebas unitarias y de integración
/migrations # Archivos de migraciones Django
/config # Archivos de configuración del proyecto y bases de datos
