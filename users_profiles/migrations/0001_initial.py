...
import users_profiles.models.user
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "password_change",
                    models.BooleanField(
                        default=False, verbose_name="Requiere cambio de contraseña"
                    ),
                ),
                (
                    "last_session",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Última sesión"
                    ),
                ),
                (
                    "account_statement",
                    models.CharField(
                        default="A", max_length=1, verbose_name="Estado de cuenta"
                    ),
                ),
                (
                    "email_verified_at",
            ...
            managers=[
                ("objects", users_profiles.models.user.UserManager()),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_used",
                    models.BooleanField(default=False, verbose_name="Código usado"),
                ),
                (
                    "max_attempts",
                    models.IntegerField(default=3, verbose_name="Máximo de intentos"),
                ),
                (
                    "code",
                    models.CharField(
