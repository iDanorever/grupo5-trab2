...
# Campos confirmados por el traceback:
#   username, email, first_name, paternal_lastname, maternal_lastname,
#   sex, is_active, is_staff, is_superuser, date_joined, updated_at
# -------------------------------------------------------------------
